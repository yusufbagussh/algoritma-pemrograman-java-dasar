...
class CobaMethodKasir {
    public static void main(String[] abc) {
        ...
        System.out.println(
                "=================================================== DATA PEMBELIAN ================================================");
        listpembelian(jnsbeli, kodebarang, namabarang, hargabarang, jmlbeli, subtotal, totalharga, j);
    ...
    // public static void datapembelian(int j, String[] kodebarang, String[]
    // namabarang, int[] hargabarang, int[] jmlbeli,
    // int[] subtotal) {
    // System.out.println("Kode Barang Nama Barang Harga Per Item Jumlah Pembelian
    // Harga Total");
    // System.out.println("" + kodebarang[j] + " " + namabarang[j] + " Rp. " +
    // hargabarang[j]
    // + " " + jmlbeli[j] + " Rp. " + subtotal[j] + "");
    // }

    public static void listpembelian(int jnsbeli, String[] kodebarang, String[] namabarang, int[] hargabarang,
            int[] jmlbeli, int[] subtotal, int totalharga, int j) {
        for (j = 1; j <= jnsbeli; j++) {
